...
export default function SinglePropertyForm() {
  ...
  return (
    <section className="bg-[#2B3D56] mb-10 flex flex-col items-center text-center justify-between rounded-lg p-4 w-full max-w-[350px] mx-auto ">
      <div className="grid lg:grid-cols-1 gap-10 w-full text-white">
        {/* Left Text Section */}
        ...
        <form onSubmit={handleSubmit} className=" text-gray-700 space-y-4">
          ...
          <button
            type="submit"
            className="w-[100%] p-3 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition-colors"
          >
            Submit
          </button>
        </form>
