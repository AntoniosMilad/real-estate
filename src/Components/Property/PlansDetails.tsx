  ...
  return (
    <section className="flex flex-col gap-6 w-[80%]">
      <article className="flex flex-row gap-6 ">
        <div className="border-[1px] border-gray-200 rounded-md w-[15%] h-[255px] flex flex-col items-center py-5">
        ...
        <div className="border-[1px] border-gray-200 rounded-md w-[30%] h-[255px] flex flex-col p-5">
        ...
        <div className="border-[1px] border-gray-200 rounded-md w-[50%] h-[255px] flex flex-col p-5">
      ...
      <article>
        ...
        <p className="my-3 w-[60%] text-black text-[15px] text-justify leading-[27px]">
